...
const industries = ["Forex Trading Bots", "Crypto Arbitrage Tools", "Stock Market AI Indicators", "Copy Trading Platforms", "Algorithmic Trading Software"];
...
async function generateSeedTopicsBatch(batchSize = 20) {
  ...
  const prompt = `
You are a Algorithmic Trading Analyst for AITraderEA. Focus on backtesting results, drawdown limits, win rates, broker compatibility, and risk management strategies.
